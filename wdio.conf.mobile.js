...
exports.config = {
    ...
    specs: [
        './src/features/Web-Mobile/**/MOB_ConnexionCompte.feature',
    ],
    // Suites de tests
    suites: {
        complet: [
            './src/features/Web-Mobile/suite_Complete/**.feature'
        ],
        beb: [
    ...
    cucumberOpts: {
        ...
        tagExpression: 'not @BUG and not @NA and not @TODO and not @SEPA and not @PMUS and not @ATTENTE and not @MKP',
        //// MEP a blanc
        ...
        //// MEP
        //tagExpression: 'not @BUG and not @NA and not @TODO and @MEP',
        tagsInTitle: false,
